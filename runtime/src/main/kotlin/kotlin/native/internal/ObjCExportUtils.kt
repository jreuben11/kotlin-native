...
internal class NSSetAsKSet : AbstractSet<Any?>(), kotlin.native.internal.KonanSet<Any?>, ObjCObjectWrapper {
...
@ExportForCppRuntime private fun Kotlin_Set_getElement(set: Set<Any?>, element: Any?): Any? =
        if (set is kotlin.native.internal.KonanSet<Any?>) {
...
private fun Kotlin_ObjCExport_abortIfUnchecked(exception: Throwable) {
    if (exception.isUncheckedException()) {
        ...
        kotlin.native.internal.ReportUnhandledException(exception)
